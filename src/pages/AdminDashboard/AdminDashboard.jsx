...
import Toastify, {notifyWarn} from "../../thirdparty/toastify"
  ...
  return (
    <div className="flex flex-col gap-10 max-w-7xl w-full mx-auto">
      <div className="flex gap-4 w-full">
        ...
        <BoxInfo
        onClick={() => notifyWarn("Feature Not Available")}
        className="bg-orange-400"
        link="/"
        component={<FaCircleExclamation className="size-6 fill-orange-600"/>} total="0" title="Pending Task"/>
        <BoxInfo 
        onClick={() => notifyWarn("Feature Not Available")}
        className="bg-emerald-400"
        link="/"
        component={<FaCircleCheck  className="size-6 fill-emerald-600"/>} total="0" title="Completed Task"/>
      </div>
